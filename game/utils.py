...
for angle in angle_values:
    ...
    print(f"Angle: {angle}°, Slope as fraction: {slope_value[0]:.4f}/{slope_value[1]:.4f}, Slope as decimal: {slope_value[0]/slope_value[1]:.4f}")
...
def calculate_face_midpoint(entity_surface_object):
    ...
    face_midpoint_x = entity_surface_object.rect.centerx + (face_length / 2) * math.cos(angle_radians)
    face_midpoint_y = entity_surface_object.rect.centery - (face_length / 2) * math.sin(angle_radians)
